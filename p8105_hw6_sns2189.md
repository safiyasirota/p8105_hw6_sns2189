...
*β̂*<sub>0</sub> and *β̂*<sub>1</sub> from a `broom::tidy(fit)` results
and a function to get the *r̂*<sup>2</sup> value from a
`broom::glance(fit)` result that will come in handy later.
...
The distribution for *l**o**g*(*β̂*<sub>0</sub> \* *β̂*<sub>1</sub>) seems
normal around a mean of about 2.01. The distribution of *r̂*<sup>2</sup>
...
From bootstrapping, our estimate for *r̂*<sup>2</sup> is 0.911 (95% CI
\[0.894, 0.927\]). Our estimate for
*l**o**g*(*β̂*<sub>0</sub> \* *β̂*<sub>1</sub>) is 2.013 (95% CI \[1.965,
2.059\]).
